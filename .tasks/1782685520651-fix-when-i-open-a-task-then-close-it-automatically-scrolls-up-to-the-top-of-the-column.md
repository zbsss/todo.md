...
updated_at: 1783015729923
---

It should remain in the same position i was when i opened that task.

Same happens when i create a new task. The task it added at the bottom, but the UI scrolls to the top of the column. In that case it should actually scroll to the bottom to show the new task.
